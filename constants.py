australia_states = ['New South Wales', 'Northern Territory', 'Queensland', 'South Australia', 'Tasmania', 'Victoria', 'Western Australia']
...
sample_colors = ['Red', 'Blue', 'Green', 'Yellow', 'Orange']